    ...
    >
      ...
      >
        ...
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-base font-semibold text-(--color-text)">Upload post</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {error && (
            <p className="rounded-lg px-3 py-2 text-sm text-red-400" style={{ background: "var(--color-bg)" }}>
              {error}
            </p>
          )}
          {success && (
